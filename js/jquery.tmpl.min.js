/*
 * jQuery Templates Plugin 1.0.3pre
 * mod 211
 *
 * - for 
 		usage:
 ...
 * - Parse Int
  ...
  * - Format Date
 		usage:
 		{{todatestring("es-ES", {weekday: \'long\', year: \'numeric\', month: \'long\', day: \'numeric\'}) v.date}}	
 *
 * --------------------------------------------
...
(function( jQuery, undefined ){
	...
	jQuery.extend( jQuery.tmpl, {
		tag: {
			...
			"parsefloat": {
				open: "if($notnull_1){__.push(parseFloat($1a));}"
			},
			"parseint": {
				open: "if($notnull_1){__.push(parseInt($1a));}"
			},
			"todatestring": {
				...
				open: "if($notnull_1){__.push(new Date($1a).toLocaleDateString($2));}"
			}
		},
